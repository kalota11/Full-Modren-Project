 ...
 const Services = () => {
  return (
   <Section id="how-to-use">
    ...
    <img src={service2} className="h-full w-full object-cover" width={630} height={730} alt="robot" />
    </div>
  ...
  <h4 className="h4 mb-4">Video generation</h4>
    ...
    engine. What will you create?
                ...
                {brainwaveServicesIcons.map((item,index) => (
                    <li key={index} className={`rounded-2xl flex items-center justify-center ${index === 2 ? 'w-[3rem] h-[3rem] p-0.25 bg-conic-gradient md:w-[4.5rem] md:h-[4.5rem]' : 'flex w-10 h-10 bg-n-6 md:h-15 '}`}>
   ...
   <div className="relative h-[120rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]">
